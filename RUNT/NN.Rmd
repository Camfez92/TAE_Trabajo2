...
```{python}
model = Sequential()
model.add(Dense(40, input_dim=7,kernel_initializer='he_uniform', activation='softmax'))
...
```{python}
model.fit(X_train, y_train, epochs=1000, batch_size=100,verbose=0, validation_split=0.3,shuffle=True)
```
```{python}
